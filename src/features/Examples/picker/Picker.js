...
function DisabledPickerExample() {
  ...
  return (
    <Picker enabled={true} selectedValue={value}>
      <Item label="hello" value="key0" />
      <Item label="world" value="key1" />
    </Picker>
  );
...
export default function PickerExamples() {
  return (
    <ExampleContainer title="react-native-picker">
      <View>
        <BasicPickerExample />
        <StyledPickerExample />
        <DisabledPickerExample />
        <DisabledSpecificPickerExample />
        <ColorPickerExample />
        <NoListenerPickerExample />
        <CustomDropdownArrowColorPickerExample />
        <DropdownPickerExample />
        <PromptPickerExample />
        <PromptMultilinePickerExample />
        <DropdownMultilinePickerExample />
      </View>
    </ExampleContainer>
  );
}
